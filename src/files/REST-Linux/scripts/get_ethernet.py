...
def print_netport(resp):
    port_message = resp["resource"]["Oem"][common_function.COMMON_KEY]
...
def print_ip(resp):
    print("[IP]")
    ip_version = resp["resource"]["Oem"][common_function.COMMON_KEY]["IPVersion"]
...
def print_dns(resp):
    ...
    mode = resp["resource"]["Oem"][common_function.COMMON_KEY]["DNSAddressOrigin"]
    # Display information.
    print("")
