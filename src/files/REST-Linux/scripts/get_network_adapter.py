...
def getnetworkadapter(client, args):
    '''
    #====================================================================================
...
def get_network_ports(client, network_ports):
    ...
    for network_port in network_ports:
        ...
        oem = resp['resource']['Oem'][common_function.COMMON_KEY]
...
def get_network_adapter_info(client, resource_uri):
    ...
    network_ports = resp['resource']['Controllers'][0]['Links']['NetworkPorts']
...
def get_summary(client):
    ...
    if sys_resp['status_code'] == 200:
        oem = sys_resp['resource']['Oem'][common_function.COMMON_KEY]
